...
import com.SchoolProject2.exception.DepartmentIdNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleDepartmentIdNotFound(DepartmentIdNotFoundException ex) {
